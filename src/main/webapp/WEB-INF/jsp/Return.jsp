...
<body>
	...
	<form action='ReturnServlet' method='post'>
		<label for='Return-time'>返却日</label> 
		<input type='datetime-local' id='Return-time' name='Return-time'> <label for='medicalEquiment'>4桁番号</label>
		<input type='text' name='medicalEquiment' pattern='[1-9][0-9]{3}'> 
		<input type='submit' value='返却登録'>
	</form>
	<nav>
